export default function OocPage() {
  return (
    <main className="flex flex-col items-center text-center p-5 w-4/5 m-auto">
      ...
      <p>
        In character, This is a incomplete and flawwed database, expect agents
        to get even basic facts wrong and dont expect the lore to line up, Alot
        of the entrys are made from second hand information or untrustworthly
        sources.
      </p>
