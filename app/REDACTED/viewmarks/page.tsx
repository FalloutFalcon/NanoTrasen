      ...
      <table className="border border-slate-500 w-1/2 md:w-4/5">
        <thead>
          <tr className="flex flex-row">
            ...
            <th className="border border-slate-500 hidden md:w-1/5 md:table-cell">Position</th>
            <th className="border border-slate-500 hidden md:w-1/5 md:table-cell">Department</th>
            <th className="border border-slate-500 w-1/3 md:w-1/5">Affiliation</th>
          </tr>
        </thead>
        <tbody>
          {marks.rows &&
            marks.rows.map((mark: QueryResultRow) => (
              <tr key={mark.id} className="break-all md:break-normal flex flex-row">
                <td className="border border-slate-500 line-clamp-1 w-1/3 md:w-1/5">{mark.id}</td>
                ...
                <td className="border border-slate-500 line-clamp-1 hidden md:w-1/5 md:table-cell text-xs md:text-base">{mark.position}</td>
                <td className="border border-slate-500 line-clamp-1 hidden md:w-1/5 md:table-cell text-xs md:text-base">{mark.department}</td>
                <td className="border border-slate-500 line-clamp-1 w-1/3 md:w-1/5 text-xs md:text-base">{mark.affiliation}</td>
              </tr>
            ))}
        </tbody>
      </table>
